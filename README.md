...
- Dashboard with model overview, content stats, AI actions
- Monaco JSON editor for schemas and content
- Searchable model list with filters
- AI actions: Generate Content, Find Stale Content, Bulk Update, Export
- Summary endpoints for AI-friendly data
- PS1 scripts for instant data fetching
